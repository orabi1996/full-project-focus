              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <Badge
                      variant="outline"
                      className="text-[10px] rounded-full px-2.5 font-bold border-primary/30 text-primary"
                    >
                      {employee.workType === "remote"
                        ? "عمل عن بعد"
                        : employee.workType === "hybrid"
                          ? "عمل هجين"
                          : "حضور مكتبي"}
                    </Badge>
                  </div>
              ...
              <div className="rounded-3xl border border-border/80 bg-card p-5 shadow-xs space-y-4">
                <div className="flex items-center gap-2 border-b border-border/60 pb-3">
                  ...
                  <h4 className="font-black text-xs text-foreground">
                    بيانات الهوية الشخصية والأحوال المدنية
                  </h4>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div className="rounded-3xl border border-border/80 bg-card p-5 shadow-xs space-y-3.5">
                  <div className="flex items-center gap-2 border-b border-border/60 pb-3">
                    ...
                    <h4 className="font-black text-xs text-foreground">
                      العنوان الوطني الموحد (Saudi Post)
                    </h4>
                  </div>
            ...
            <TabsContent value="job" className="space-y-4 pt-4">
              <div className="rounded-3xl border border-border/80 bg-card p-5 shadow-xs space-y-4">
                <div className="flex items-center gap-2 border-b border-border/60 pb-3">
                  ...
                  <h4 className="font-black text-xs text-foreground">
                    الهيكل الوظيفي، العقد، ومسار الترقية
                  </h4>
                </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    {isEditing ? (
                      <select
                        ...
                        onChange={(e) =>
                          setFormData({ ...formData, workLocationId: e.target.value })
                        }
                        className="w-full h-10 rounded-2xl border border-border/80 bg-muted/40 px-3 font-bold focus:bg-card focus:outline-none focus:ring-2 focus:ring-primary/40"
                      >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <p className="font-bold text-foreground bg-muted/20 p-2.5 rounded-2xl">
                      {employee.contractType === "full_time"
                        ? "دوام كامل (Full Time)"
                        : "دوام جزئي"}{" "}
                      • {employee.workType === "remote" ? "عن بعد" : "هجين"}
                    </p>
                  </div>
                </div>
              </div>
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {(
                          ...
                          <Badge
                            key={idx}
                            variant="secondary"
                            className="text-[10px] rounded-full px-2.5 py-1 font-bold"
                          >
                            ✓ {cert}
                          </Badge>
                        ))}
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {(
                          employee.languages || [
                            "العربية (اللغة الأم)",
                            "الإنجليزية (طلاقة احترافية)",
                          ]
                        ).map((lang, idx) => (
                          <Badge
                            key={idx}
                            variant="outline"
                            className="text-[10px] rounded-full px-2.5 py-1 font-bold border-primary/30 text-primary"
                          >
                            🌐 {lang}
                          </Badge>
                        ))}
            ...
            <TabsContent value="activity" className="space-y-4 pt-4">
              <div className="rounded-3xl border border-border/80 bg-card p-5 shadow-xs space-y-4">
                <div className="flex items-center gap-2 border-b border-border/60 pb-3">
                  ...
                  <h4 className="font-black text-xs text-foreground">
                    سجل طلبات الموظف والاعتمادات السابقة
                  </h4>
                </div>
