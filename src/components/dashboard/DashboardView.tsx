      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          ...
          <div className="mt-3 flex items-baseline gap-2">
            ...
            <Badge
              variant="outline"
              className="text-[10px] bg-purple-500/10 text-purple-700 border-purple-200"
            >
              جاهز للمراجعة
            </Badge>
          </div>
          ...
          <div className="space-y-3">
            <div className="rounded-lg border border-primary/20 bg-primary/5 p-3 text-xs space-y-1">
              ...
              <p className="text-[11px] text-muted-foreground">
                تم اعتماد سياسة الدوام المرن والعمل عن بعد بنسبة 40% لجميع فرق هندسة البرمجيات
                والتطوير.
              </p>
              <div className="pt-1 text-[10px] text-primary/70">
                قبل يومين • إدارة الموارد البشرية
              </div>
            </div>
